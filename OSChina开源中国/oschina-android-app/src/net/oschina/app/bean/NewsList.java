...
public class NewsList extends Entity {
	...
	public final static int CATALOG_ALL = 1;// catalog_all
	public final static int CATALOG_INTEGRATION = 2;// catalog_integration
	public final static int CATALOG_SOFTWARE = 3;// catalog_software
