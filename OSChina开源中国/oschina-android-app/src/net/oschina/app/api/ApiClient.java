...
import net.oschina.app.common.StringHelp;
...
public class ApiClient {
	...
	public static NewsList getNewsList(AppContext appContext,
		...
		Log.i("andli", "新闻列表---URL：" + newUrl);
		try {
			// String bs = StringHelp.InputStreamTOString(http_get(appContext,
			// newUrl));
			// Log.i("andli", "新闻列表BS=" + bs);
			// Log.i("andli",NewsList.parse(http_get(appContext,
			// newUrl)).getNewslist().size()+"");
