...
package com.teleca.jamendo.activity.download;

import java.util.ArrayList;

import com.teleca.jamendo.MyApplication;
import com.teleca.jamendo.adapter.DownloadJobAdp;
...
public class DownloadView extends Activity {
	...
	public static void launch(Context c){
		Intent intent = new Intent(c, DownloadView.class);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mDownloadInterface = MyApplication.getInstance().getDownloadInterface();
	...
	private void updateListView(int position){
		if(position == lastSpinnerPosition){
			DownloadJobAdp adapter = (DownloadJobAdp)mListView.getAdapter();
		...
		if(jobs != null){
			...
			DownloadJobAdp adapter = new DownloadJobAdp(DownloadView.this);
