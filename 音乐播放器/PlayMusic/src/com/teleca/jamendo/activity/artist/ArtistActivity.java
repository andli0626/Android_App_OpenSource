...
package com.teleca.jamendo.activity.artist;
...
import com.teleca.jamendo.adapter.AlbumGridAdp;
...
import com.teleca.jamendo.ui.loadDialog.ArtistLoadDialog;
...
public class ArtistActivity extends Activity {
	...
	private AlbumGridAdp mAlbumGridAdapter;
	...
	public static void launch(Activity c, String artistName){
		new ArtistLoadDialog(c,R.string.artist_loading, R.string.artist_fail).execute(artistName);
	}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mAlbumGridAdapter = new AlbumGridAdp(this);
...
//		Album[] albums = server.searchForAlbumsByArtist(artistName);
	...
	private OnItemClickListener mOnItemClickListener = new OnItemClickListener(){
		...
		public void onItemClick(AdapterView<?> adapter, View view, int position,
			...
			AlbumView.launch(ArtistActivity.this, album);
		}
	 ...
	 * @author Lukasz Wisniewski
	 */
	private class AddToPlaylistLoadingDialog extends LoadDialog<Album, Track[] >{
		...
		public Track[] doInBackground(Album... params) {
			...
			try {
				tracks =  service.getAlbumTracks(mAlbum, MyApplication.getInstance().getStreamEncoding());
