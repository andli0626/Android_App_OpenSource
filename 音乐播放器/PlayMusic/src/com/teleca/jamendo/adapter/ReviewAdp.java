 ...
 */
public class ReviewAdp extends BaseAdp<Review> {
	...
	public ReviewAdp(Activity context) {
		super(context);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (row==null) {
			...
			holder.reviewAvatar = (MyImageView)row.findViewById(R.id.ReviewAvatar);
