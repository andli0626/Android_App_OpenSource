 ...
 */
public class DownloadJobAdp extends BaseAdp<DownloadJob> {

	public DownloadJobAdp(Activity context) {
		super(context);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Playlist playlistEntry = mList.get(position).getPlaylistEntry();
