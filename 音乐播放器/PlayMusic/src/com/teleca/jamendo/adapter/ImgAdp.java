...
public class ImgAdp extends AlbumAdp {

	int mIconSize;

	public ImgAdp(Activity context) {
		super(context);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			i = new MyImageView(activity);
			i.setScaleType(MyImageView.ScaleType.FIT_CENTER);
			i.setLayoutParams(new Gallery.LayoutParams(mIconSize, mIconSize));
		} else {
			i = (MyImageView) convertView;
		}
