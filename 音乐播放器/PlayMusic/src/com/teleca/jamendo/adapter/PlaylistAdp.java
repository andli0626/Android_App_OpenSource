 ...
 */
public class PlaylistAdp extends BaseAdapter {
	...
	public PlaylistAdp(Activity context) {
		mContext = context;
		mLayoutId = R.layout.track_row;
	}
	
	public PlaylistAdp(Activity context, int layoutId) {
		mContext = context;
		mLayoutId = layoutId;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Playlist playlistEntry = mPlaylist.getTrack(position);
	...
	public void setPlaylist(PlayMethod playlist) {
		this.mPlaylist = playlist;
		notifyDataSetChanged();
	}

	public PlayMethod getEntryList() {
		return mPlaylist;
	}
