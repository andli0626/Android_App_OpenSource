...
public class FavoritesActivity extends CourseBaseView {
	...
	protected String getActivityTitle() {
		...
		String who;
		if (getUserId().equals(AppParam.getMyselfId(false))) {
			who = "我";
		} else {
			who = getUserName();
		}
	...
	public String getUserId() {
		...
		if (extras != null) {
			...
			userId = AppParam.getMyselfId(false);
		}
	...
	public String getUserName() {
		...
		if (extras != null) {
			...
			userName = AppParam.getMyselfName(false);
		}
