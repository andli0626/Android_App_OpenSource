...
//	private ProgressDialog dialog;
	...
	private ITaskListener mLoginTaskListener = new AbstractTaskAdapter() {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mUsernameEdit.setText("ww1095@163.com");
	...
	protected void onDestroy() {
		...
		TaskFeedback.getInstance(TaskFeedback.DIALOG_MODE, LoginView.this)
				.cancel();
		super.onDestroy();
	}
	...
	private void onLoginSuccess() {
		...
		AppParam.mApi.setCredentials(mUsername, mPassword);
	...
	private class LoginTask extends GenericTask {
		...
		protected TaskResult _doInBackground(TaskParams... params) {
			...
			try {
				...
				user = AppParam.mApi.login(username, password);

				AppParam.getMyselfId(true);
				AppParam.getMyselfName(true);
