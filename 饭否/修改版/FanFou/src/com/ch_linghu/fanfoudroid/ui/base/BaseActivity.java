...
import com.ch_linghu.fanfoudroid.ui.LoginView;
...
public class BaseActivity extends Activity {
	...
	protected boolean _onCreate(Bundle savedInstanceState) {
		...
		if (!checkIsLogedIn()) {
			...
			mPreferences = AppParam.mPref; // PreferenceManager.getDefaultSharedPreferences(this);
	...
	private void _logout() {
		...
		// TODO: 提供用户手动情况所有缓存选项
		AppParam.mImageLoader.getImageManager().clear();
