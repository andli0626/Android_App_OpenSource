...
public class UserArrayAdapter extends BaseAdapter implements TweetAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		SharedPreferences pref = AppParam.mPref; // PreferenceManager.getDefaultSharedPreferences(mContext);
		...
		if (useProfileImage) {
			if (!TextUtils.isEmpty(profileImageUrl)) {
				holder.profileImage
						.setImageBitmap(AppParam.mImageLoader.get(
				...
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						if (cancelFollowingTask != null
							...
							cancelFollowingTask.setListener(new AbstractTaskAdapter() {//闭包？
								@Override
				...
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						if (setFollowingTask != null
							...
							setFollowingTask
									.setListener(new AbstractTaskAdapter() {
